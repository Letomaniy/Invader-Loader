...
HANDLE CLoad::LoadFromResources(int IDD_RESOUCE)
{
        ...
        if (((hResInfo = FindResource(hModule, MAKEINTRESOURCE(IDD_RESOUCE), (LPCWSTR)"DLL")) != NULL) && ((hResData = LoadResource(hModule, hResInfo)) != NULL) && ((pvRes = LockResource(hResData)) != NULL))
        {
